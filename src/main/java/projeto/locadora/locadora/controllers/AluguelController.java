...
public class AluguelController {
    ...
    public void persistirAluguel(@RequestBody @Valid AluguelForm form) throws NotFoundException {
        ...
        Message message = new Message(("Aluguel do carro " +form.getPlaca_carro() + " para o cliente com CPF " + form.getCpf() + " concluído com sucesso.").getBytes());
        rabbitTemplate.send("aluguel.concluido",message);
    }
